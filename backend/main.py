"""
datavalidator-api - Backend API
DataValidator API: Schema validation and data quality API for ETL pipelines
"""
...
app = FastAPI(
    title="datavalidator-api",
    description="DataValidator API: Schema validation and data quality API for ETL pipelines",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "datavalidator-api"}
